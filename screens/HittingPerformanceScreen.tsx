    ...
    <View style={styles.container}>
      ...
      <FABMenu
        ...
        items={[
          ...
          ...(hasPitchingData || hasArmCareData || isMember ? [{ id: 'pitching', label: 'Pitching', icon: 'baseball', iconFamily: 'material-community' as const, onPress: () => navigation.navigate('PitchingHub', { athleteId }) }] : []),
